$(function () {
    ...
    new PerfectScrollbar(".header-notifications-list"),
        // Check if the URL contains the link for creating an order
        // function checkURL() {
        //     var createOrderURL = $("#create-order-url").val(); // Get the URL for creating an order from the hidden input
        //     var currentURL = window.location.href; // Get the current URL

        //     console.log("Current URL:", currentURL);
        //     console.log("Create Order URL:", createOrderURL);

        //     if (currentURL.includes(createOrderURL)) {
        //         console.log("Closing sidebar...");
        //         $(".wrapper").removeClass("toggled"); // Close the sidebar by removing the "toggled" class
        //     }
        // };

    
    // Also, call the checkURL function when the hash part of the URL changes
