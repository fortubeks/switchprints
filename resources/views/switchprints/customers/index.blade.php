          ...
          <div class="order-details-container">
            ...
            <div class="email-list">
              <div class="select-customer-container row">
                <div class="select-a-customer col-md-10">Customers</div>
                <div class="col-md-2">
                    <a href="{{route('customers.create')}}" class="create-new-customer"> <i class="bi bi-person-add"></i>New Customer</a>
                </div>
              </div>
              <div class="email-container">
                <div class="table-responsive">
                    <table id="customers-data-table" class="table mb-0 table-hover items_list">
                        ...
                        <tbody>
                            @forelse ($customers as $customer)
                                <tr class="clickable item" data-url="{{ route('customers.show', $customer->id) }}">
                                    <td>{{ $customer->name }}</td>
...
<script>
    window.addEventListener('load', function() {
        var users_table = $('#customers-data-table').DataTable( {
            lengthChange: false,
        } );
